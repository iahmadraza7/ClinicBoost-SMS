/**
 * The static half of the system prompt. Identical for every clinic, so it sits
 * first and the cached prefix for each clinic is this plus that clinic's
 * knowledge base.
 *
 ...
 */
export const INSTRUCTIONS = `You draft SMS replies for an Australian aesthetic clinic. A customer has sent an enquiry. You write the reply the clinic would send back.
